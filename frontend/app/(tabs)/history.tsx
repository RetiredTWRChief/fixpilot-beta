      ...
      >
        <View style={styles.cardHeader}>
          <View style={styles.cardTitleRow}>
            <MaterialCommunityIcons name="car-wrench" size={18} color="#E5E5E5" />
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#333333',
  },
  headerTitle: { fontSize: 18, fontWeight: '500', color: '#FFFFFF', flex: 1 },
  headerCount: {
    fontSize: 12, fontWeight: '700', color: '#737373', backgroundColor: '#1F1F1F',
  ...
  cardTitle: { fontSize: 15, fontWeight: '600', color: '#E5E5E5', flex: 1 },
  cardVehicle: { fontSize: 12, color: '#737373', fontWeight: '600', letterSpacing: 0.5, marginBottom: 4 },
  cardIssue: { fontSize: 14, color: '#A3A3A3', lineHeight: 20, marginBottom: 10 },
  ...
  cardDate: { fontSize: 11, color: '#737373' },
  emptyTitle: { fontSize: 18, fontWeight: '500', color: '#A3A3A3', marginTop: 16 },
  emptyText: { fontSize: 14, color: '#737373', marginTop: 6 },
});
